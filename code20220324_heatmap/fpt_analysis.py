...
DATA_DIR = "E:/all/center"
VIDEO_DIR = r"/media/syf/SYF/todo/"
DRIVER_L = ["LC26XCS31 LC26XTrp31 LC26XShi31"]
...
ONLY_UPDATE_GENO = ['CSXTrp31 T45XTrp31 T45XShi31',
                    'CSXTrp31 LC25XTrp31 LC25XShi31',
                    'CSXTrp31 LC9XTrp31 LC9XShi31',
                    'CSXTrp31 LC13XTrp31 LC13XShi31'
                    'CSXTrp31 LC17XTrp31 LC17XShi31']#"FBSNPXCS31", "LC16XCS31", "LC12XCS31",
...
def plot_all_pair_out(all_geno_d, data_type, figure_name, out_file=None):
    ...
    multi_info = np.array(multi_info).reshape((-1, 6)).T
