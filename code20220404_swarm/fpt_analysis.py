...
DATA_DIR = r'E:/LC_screening/SYF/test/center'
VIDEO_DIR = r"/media/syf/SYF/todo/"
DRIVER_L = ["CSXTrp31 LC21XTrp31 LC21XShi31"]
...
def _plot_swarm(df, keys, path, key_x="geno", swarm=True, violin=False, width=2.6, suptitle="", col=None, palette=None, ylabel=None):
    ...
    i = 0
    fig, axes = plt.subplots(row, col, dpi=300) #,sharex=True),  figsize=(col*width*SWARM_WIDTH_SCALE, row*width*SWARM_HEIGHT_SCALE)
