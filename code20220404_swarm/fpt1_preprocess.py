...
import os
import cv2
from fpt_ui import InputExpInfoUI, InputRoiInfoUI, InputBgInfoUI
from fpt_util import load_dict, save_dict, find_file, rename_video_t, get_video_in_dir, cmp_file
...
def input_meta_info(video, cap, info=None):
    ...
    # idx, {roi(2x2)}, {male_geno}, {male_date}, male_days
