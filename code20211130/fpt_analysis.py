...
DATA_DIR = r'F:/LC_screening/SYF/LC4/center'
VIDEO_DIR = r'F:/LC_screening/SYF/LC4/video'
DRIVER_L = ["CSXTrp31 LC4XTrp31 LC4XShi31"]
...
ONLY_UPDATE_GENO = []#"FBSNPXCS31", "LC16XCS31", "LC12XCS31", 'CSXTrp31 LC4XTrp31 LC4XShi31'
    ...
    if use_pickle and os.path.exists(pickle_name):
        ...
        if geno_folders_out_d:  # NOTE: data in other GENO_DATA_DIR
            for geno_data_dir, geno_folders_out in geno_folders_out_d.items():
                data_name = geno_data_dir.split("/")[1] + "/"  # data1
                for geno in geno_folders_out:
...
def ana_main(cmd=None, data_i=None):
    ...
    if cmd == "p":
        ...
        driver_out_d = {"F:/exp/data_TB2": ["TBXCS31", "TBXShi31", "CSXShi31"], # 202107
                        "G:/data_screen": ["TBXCS31", "TBXShi31", "TBXTrp31",], # 202012
                        "G:/data2s": ["CSXShi31", "TBXShi31", "TBXTrp31"], # 201907
                        "G:/data3s": ["CSXShi31", "TBXShi31", "TBXTrp31"], # 201909
                        "G:/data4s": ["CSXShi31"]} # 201911
        SWARM_PALATTE = [a for a in "cgbcgrgrbgrbb"]
        PLOT_DRIVER_GROUP = 3
